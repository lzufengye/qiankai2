...
/***/ function(module, exports, __webpack_require__) {
	...
	var _convenienceLife = __webpack_require__(250);

	var _convenienceLife2 = _interopRequireDefault(_convenienceLife);

	var _about = __webpack_require__(252);

	var _about2 = _interopRequireDefault(_about);

	var _articleList = __webpack_require__(251);
	...
	var _educationService = __webpack_require__(254);

	var _educationService2 = _interopRequireDefault(_educationService);

	var _innovationSpace = __webpack_require__(255);

	var _innovationSpace2 = _interopRequireDefault(_innovationSpace);
	...
	_reactDom2.default.render(_react2.default.createElement(
	  ...
	  _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      _reactRouter.Route,
	      { path: '/convenience-life', component: _convenienceLife2.default },
	      _react2.default.createElement(_reactRouter.Route, { path: '/convenience-life/:title', component: _articleList2.default }),
	      _react2.default.createElement(
	        _reactRouter.Route,
	        { path: '/convenience-life/:title' },
	        _react2.default.createElement(_reactRouter.Route, { path: '/convenience-life/:title/:category', component: _articleList2.default })
	      )
	    ),
	    _react2.default.createElement(
	      _reactRouter.Route,
	      { path: '/education-service', component: _educationService2.default },
	      _react2.default.createElement(
	        _reactRouter.Route,
	        { path: '/education-service/:title' },
	        _react2.default.createElement(_reactRouter.Route, { path: '/education-service/:title/:category', component: _articleList2.default })
	      )
	    ),
	    _react2.default.createElement(
	      _reactRouter.Route,
	      { path: '/innovation-space', component: _innovationSpace2.default },
	      _react2.default.createElement(_reactRouter.Route, { path: '/innovation-space/:title', component: _articleList2.default }),
	      _react2.default.createElement(
	        _reactRouter.Route,
	        { path: '/innovation-space/:title' },
	        _react2.default.createElement(_reactRouter.Route, { path: '/innovation-space/:title/:category', component: _articleList2.default })
	      )
	    ),
	    _react2.default.createElement(_reactRouter.Route, { path: '/about', component: _about2.default }),
	    _react2.default.createElement(_reactRouter.Route, { path: '/search/:searchValue', component: _articleList2.default }),
	    _react2.default.createElement(_reactRouter.Route, { path: '/:title/:id', component: _article2.default })
	  )
	...
	var Header = _react2.default.createClass({
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      'div',
	      { className: 'header' },
	      _react2.default.createElement('image', { className: 'logo', src: '/assets/images/logo.png' }),
	      _react2.default.createElement(
	        _menu2.default,
	        null,
	        _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'a',
	          { href: 'http://www.sxstg.cn/', target: '_blank' },
	          '三峡生态购'
	        ),
	        _react2.default.createElement(
	          _navLink2.default,
	          { to: '/convenience-life/newses' },
	          '便民生活'
	        ),
	        _react2.default.createElement(
	          _navLink2.default,
	          { to: '/education-service/articles/learning' },
	          '教育服务'
	        ),
	        _react2.default.createElement(
	          _navLink2.default,
	          { to: '/innovation-space/activities' },
	          '众创空间'
	        ),
	        _react2.default.createElement(
	          _navLink2.default,
	          { to: '/about', onlyActiveOnIndex: true },
	          '关于我们'
	        ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchBar = _react2.default.createClass({
	  ...
	  handleSearch: function handleSearch(event) {
	    event.preventDefault();
	    var keyWord = event.target.elements[0].value;
	    _reactRouter.browserHistory.push('/search/' + keyWord);
	  },
	  render: function render() {
	    return _react2.default.createElement(
	      'form',
	      { onSubmit: this.handleSearch, className: 'search-bar' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _imageWithTitle = __webpack_require__(224);

	var _imageWithTitle2 = _interopRequireDefault(_imageWithTitle);

	var _slider = __webpack_require__(225);

	var _slider2 = _interopRequireDefault(_slider);

	var _sectionTitle = __webpack_require__(246);

	var _sectionTitle2 = _interopRequireDefault(_sectionTitle);

	var _block = __webpack_require__(247);

	var _block2 = _interopRequireDefault(_block);

	var _informationBoard = __webpack_require__(248);

	var _informationBoard2 = _interopRequireDefault(_informationBoard);

	var _navLink = __webpack_require__(163);

	var _navLink2 = _interopRequireDefault(_navLink);

	var _serverConfig = __webpack_require__(249);
	...
	var Home = _react2.default.createClass({
	  ...
	  loadHotProductsFromServer: function loadHotProductsFromServer() {
	    $.ajax({
	      url: _serverConfig2.default['serverUrl'] + '/api/products?hot=true',
	      dataType: 'json',
	      cache: false,
	      ...
	      error: function (xhr, status, err) {
	        console.error(_serverConfig2.default['serverUrl'] + '/api/products', status, err.toString());
	      }.bind(this)
	    });
	  },

	  loadHotNewsesFromServer: function loadHotNewsesFromServer() {
	    $.ajax({
	      url: _serverConfig2.default['serverUrl'] + '/api/newses?latest=true',
	      dataType: 'json',
	      cache: false,
	      success: function (data) {
	      ...
	      error: function (xhr, status, err) {
	        console.error(_serverConfig2.default['serverUrl'] + '/api/newses', status, err.toString());
	      }.bind(this)
	    });
	  },

	  loadJobInfosFromServer: function loadJobInfosFromServer() {
	    $.ajax({
	      url: _serverConfig2.default['serverUrl'] + '/api/jobs?latest=true',
	      dataType: 'json',
	      cache: false,
	      success: function (data) {
	      ...
	      error: function (xhr, status, err) {
	        console.error(_serverConfig2.default['serverUrl'] + '/api/jobs', status, err.toString());
	      }.bind(this)
	    });
	  },
	  ...
	  loadArticlesFromServer: function loadArticlesFromServer() {
	    $.ajax({
	      url: _serverConfig2.default['serverUrl'] + '/api/articles?category=learning',
	      dataType: 'json',
	      cache: false,
	      success: function (data) {
	      ...
	      error: function (xhr, status, err) {
	        console.error(_serverConfig2.default['serverUrl'] + '/api/articles', status, err.toString());
	      }.bind(this)
	    });
	  },

	  loadActivitiesFromServer: function loadActivitiesFromServer() {
	    $.ajax({
	      url: _serverConfig2.default['serverUrl'] + '/api/activities',
	      dataType: 'json',
	      cache: false,
	      success: function (data) {
	      ...
	      error: function (xhr, status, err) {
	        console.error(_serverConfig2.default['serverUrl'] + '/api/activities', status, err.toString());
	      }.bind(this)
	    });
	  },

	  loadAdvertisementFromServer: function loadAdvertisementFromServer() {
	    $.ajax({
	      url: _serverConfig2.default['serverUrl'] + '/api/advertisements',
	      dataType: 'json',
	      cache: false,
	      success: function (data) {
	      ...
	      error: function (xhr, status, err) {
	        console.error(_serverConfig2.default['serverUrl'] + '/api/advertisements', status, err.toString());
	      }.bind(this)
	    });
	  },
	  ...
	  render: function render() {
	    var hotProducts = this.state.products.map(function (product) {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_imageWithTitle2.default, { title: product.name, src: product.image_url })
	      );
	    });
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(_sectionTitle2.default, { href: 'http://www.sxstg.cn/', backgroundImage: '/assets/images/online-shopping.jpg',
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'a',
	          { href: 'http://www.sxstg.cn/index.php?ctl=mall', target: '_blank' },
	          _react2.default.createElement(
	            _block2.default,
	            { backgroundColor: '#37bd9c',
	              width: '200px',
	        ...
	        _react2.default.createElement(
	          'a',
	          { href: 'http://www.sxstg.cn/index.php?ctl=stores', target: '_blank' },
	          _react2.default.createElement(
	            _block2.default,
	            { backgroundColor: '#d870ad',
	              width: '300px',
	        ...
	        _react2.default.createElement(
	          'a',
	          { href: 'http://www.sxstg.cn/index.php?ctl=group', target: '_blank' },
	          _react2.default.createElement(
	            _block2.default,
	            { backgroundColor: '#0c92d1',
	              width: '150px',
	        ...
	        _react2.default.createElement(
	          'a',
	          { href: 'http://www.sxstg.cn/index.php?ctl=youhuis', target: '_blank' },
	          _react2.default.createElement(
	            _block2.default,
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          _informationBoard2.default,
	          { backgroundColor: '#f6bb43', width: '400px', title: '资讯中心', link: '/convenience-life/newses' },
	          latestNewses
	        ),
	        _react2.default.createElement(
	          _navLink2.default,
	          { to: '/convenience-life/newses' },
	          _react2.default.createElement(_sectionTitle2.default, { href: '', backgroundImage: '/assets/images/kaixian1.jpg',
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            _block2.default,
	            { backgroundColor: '#ec87c1', width: '200px' },
	            _react2.default.createElement(
	              'a',
	              { href: 'http://app.alipay.com/home/appGateway.htm?appId=1000000020', target: '_blank' },
	              '手机充值',
	              _react2.default.createElement('image', { className: 'link-image', src: '/assets/images/cell-phone.png' })
	            ),
	            _react2.default.createElement(
	              'a',
	              { href: 'https://jiaofei.alipay.com/guhua.htm?_pdType=bbcjbfefaccjfbjdabhd', target: '_blank' },
	              '固话宽带',
	              _react2.default.createElement('image', { className: 'link-image', src: '/assets/images/old-typical-phone.png' })
	            ),
	            _react2.default.createElement(
	              'a',
	              { href: 'https://jiaofei.alipay.com/fare/ebppChargeEntering.htm?chargeType=catv', target: '_blank' },
	              '有线电视缴费',
	              _react2.default.createElement('image', { className: 'link-image', src: '/assets/images/tv-monitor.png' })
	            )
	          ),
	          _react2.default.createElement(
	            'a',
	            { href: 'https://jiaofei.alipay.com/jiaofei.htm?_pdType=aecfbbfgeabbifdfdieh&_scType=bacfajegafddadijhagd', target: '_blank' },
	            _react2.default.createElement(
	              _block2.default,
	              { backgroundColor: '#967bdc', width: '200px', blockIcon: '/assets/images/energy.png' },
	              _react2.default.createElement(
	                'div',
	                { className: 'title-cn' },
	                '水电煤缴费'
	          ...
	          _react2.default.createElement(
	            _block2.default,
	            { backgroundColor: '#22b658', width: '300px' },
	            _react2.default.createElement(
	              'a',
	              { href: 'http://kx.cq.gov.cn/', target: '_blank' },
	              '开县政府网',
	              _react2.default.createElement('image', { className: 'link-image', src: '/assets/images/embassy.png' })
	            ),
	            _react2.default.createElement(
	              'a',
	              { href: 'http://www.kxwsj.gov.cn/', target: '_blank' },
	              '开县卫生局',
	              _react2.default.createElement('image', { className: 'link-image', src: '/assets/images/heart-insurance-symbol.png' })
	            )
	          ),
	          _react2.default.createElement(
	            _block2.default,
	            { backgroundColor: '#8dc153', width: '200px' },
	            _react2.default.createElement(
	              'a',
	              { href: 'https://ccrprod.alipay.com/credit.htm?_pdType=bbcebbcffijdjheiaigf', target: '_blank' },
	              '信用卡还款',
	              _react2.default.createElement('image', { className: 'link-image', src: '/assets/images/credit-cards.png' })
	            ),
	            _react2.default.createElement(
	              'a',
	              { href: 'https://ebppprod.alipay.com/estate.htm?_pdType=accibafdfbdebceidcae', target: '_blank' },
	              '物业缴费',
	              _react2.default.createElement('image', { className: 'link-image', src: '/assets/images/home.png' })
	            )
	          ),
	          _react2.default.createElement(
	            _block2.default,
	            { backgroundColor: '#fb6e52', width: '200px' },
	            _react2.default.createElement(
	              'a',
	              { href: 'https://ebppprod.alipay.com/traffic.htm?_pdType=bbcjbfefaciiiieiijgj', target: '_blank' },
	              '交通违章',
	              _react2.default.createElement('image', { className: 'link-image', src: '/assets/images/car-icon.png' })
	            ),
	            _react2.default.createElement(
	              'a',
	              { href: 'http://app.alipay.com/appGateway.htm?appId=1000000113', target: '_blank' },
	              '医院挂号',
	              _react2.default.createElement('image', { className: 'link-image', src: '/assets/images/hospital-building.png' })
	            )
	          ),
	          _react2.default.createElement(
	            _navLink2.default,
	            { to: '/convenience-life/articles/kaixian' },
	            _react2.default.createElement(
	              _block2.default,
	              { backgroundColor: '#169fa5', width: '300px', blockIcon: '/assets/images/beautiful.png' },
	              _react2.default.createElement(
	                'div',
	                { className: 'title-cn' },
	                '美丽开县'
	        ...
	        _react2.default.createElement(
	          _informationBoard2.default,
	          { className: 'job-infos', backgroundColor: '#f8f8f8', width: '300px', color: '#888', title: '就业信息', link: '/convenience-life/jobs' },
	          latestJobs
	        )
	      ),
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          _informationBoard2.default,
	          { backgroundColor: '#0c92d1', width: '400px', height: '450px', title: '学习中心', link: '/education-service/articles/learning' },
	          latestArticles
	        ),
	        _react2.default.createElement(
	          'div',
	          ...
	          _react2.default.createElement(
	            _navLink2.default,
	            { to: '/education-service/articles/learning' },
	            _react2.default.createElement(_sectionTitle2.default, { href: '', backgroundImage: '/assets/images/kaixian2.jpg',
	          ...
	          _react2.default.createElement(
	            _block2.default,
	            { backgroundColor: '#37bd9c', width: '200px', blockIcon: '/assets/images/school.png' },
	            _react2.default.createElement(
	              'div',
	              { className: 'title-cn' },
	              '学校缴费'
	          ...
	          _react2.default.createElement(
	            _navLink2.default,
	            { to: '/education-service/articles/course' },
	            _react2.default.createElement(
	              _block2.default,
	              { backgroundColor: '#8dc153', width: '200px', blockIcon: '/assets/images/online-course.png' },
	              _react2.default.createElement(
	                'div',
	                { className: 'title-cn' },
	                '课程介绍'
	          ...
	          _react2.default.createElement(
	            _navLink2.default,
	            { to: '/education-service/articles/training' },
	            _react2.default.createElement(
	              _block2.default,
	              { backgroundColor: '#d870ad', width: '200px', blockIcon: '/assets/images/seo-training.png' },
	              _react2.default.createElement(
	                'div',
	                { className: 'title-cn' },
	                '教育培训'
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          _informationBoard2.default,
	          { backgroundColor: '#967bdc', width: '400px', title: '主题活动', link: '/innovation-space/activities' },
	          latestActivities
	        ),
	        _react2.default.createElement(
	          _navLink2.default,
	          { to: '/innovation-space/activities' },
	          _react2.default.createElement(_sectionTitle2.default, { href: '', backgroundImage: '/assets/images/innovation.jpg',
	            sectionIcon: '/assets/images/innovation.png',
	            sectionTitle: '众创空间',
	            shadowMarginLeft: '0'
	          })
	        ),
	        _react2.default.createElement(_block2.default, { backgroundImage: '/assets/images/policy.jpg', width: '200px' }),
	        _react2.default.createElement(
	          _block2.default,
	          { backgroundColor: '#0c92d1', width: '200px' },
	          _react2.default.createElement(
	            _navLink2.default,
	            { to: '/innovation-space/articles/innovation_space' },
	            '众创空间展示',
	            _react2.default.createElement('image', { className: 'link-image', src: '/assets/images/project.png' })
	          ),
	          _react2.default.createElement(
	            _navLink2.default,
	            { to: '/innovation-space/articles/service' },
	            '政策与服务',
	            _react2.default.createElement('image', { className: 'link-image', src: '/assets/images/services.png' })
	          )
	        ),
	        _react2.default.createElement(
	          _navLink2.default,
	          { to: '/innovation-space/articles/incubation' },
	          _react2.default.createElement(
	            _block2.default,
	            { backgroundColor: '#f6bb43', width: '300px', blockIcon: '/assets/images/incubators.png' },
	            _react2.default.createElement(
	              'div',
	              { className: 'title-cn' },
	              '入驻与孵化'
	            ...
	            _react2.default.createElement(
	              'div',
	              { className: 'title-en' },
	              'Settle and incubation'
	            )
	          )
	        ),
	        _react2.default.createElement(
	          _navLink2.default,
	          { to: '/innovation-space/articles/cooperation' },
	          _react2.default.createElement(
	            _block2.default,
	            { backgroundColor: '#d870ad', width: '300px', blockIcon: '/assets/images/support.png' },
	            _react2.default.createElement(
	              'div',
	              { className: 'title-cn' },
	              '合作与配套'
	      ...
	      _react2.default.createElement(
	        'div',
	        { id: 'weather' },
	        _react2.default.createElement('iframe', { width: '200', scrolling: 'no', height: '75', frameborder: '0', allowtransparency: 'true', src: 'http://i.tianqi.com/index.php?c=code&id=12&icon=1&num=5' })
	      )
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Slider = __webpack_require__(226);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _innerSlider = __webpack_require__(228);
	...
	var _reactResponsiveMixin = __webpack_require__(243);

	var _reactResponsiveMixin2 = _interopRequireDefault(_reactResponsiveMixin);

	var _defaultProps = __webpack_require__(236);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mixinsEventHandlers = __webpack_require__(229);

	var _mixinsEventHandlers2 = _interopRequireDefault(_mixinsEventHandlers);

	var _mixinsHelpers = __webpack_require__(232);
	...
	var _track = __webpack_require__(238);

	var _dots = __webpack_require__(239);

	var _arrows = __webpack_require__(240);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _trackHelper = __webpack_require__(230);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactLibReactTransitionEvents = __webpack_require__(233);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var enquire = canUseDOM && __webpack_require__(245);
	var json2mq = __webpack_require__(241);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SectionTitle = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      'a',
	      { className: 'section-title', style: style, href: this.props.href },
	      _react2.default.createElement(
	        'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InformationBoard = _react2.default.createClass({
	  displayName: 'InformationBoard',
	  render: function render() {
	    var wrapperStyle = {
	      width: this.props.width,
	    ...
	    var boardStyle = {
	      backgroundColor: this.props.backgroundColor,
	      height: this.props.title == '学习中心' ? '444px' : '',
	      color: this.props.color
	    };

	    console.log('fsd', boardStyle);
	    ...
	    var title = this.props.link ? _react2.default.createElement(
	      _navLink2.default,
	      { to: this.props.link },
	      this.props.title
	    ) : this.props.title;
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'div',
	        { className: className, style: boardStyle },
	        _react2.default.createElement(
	          'div',
	...
	exports.default = InformationBoard;
...
/***/ function(module, exports) {
	...
	exports.default = { serverUrl: 'http://qiankai-admin.daoapp.io' };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ConvenienceLife = _react2.default.createClass({
	  displayName: 'ConvenienceLife',
	  getInitialState: function getInitialState() {
	    return {
	      newses: [],
	      jobs: []
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'div',
	        { className: 'left-part left-menu' },
	        _react2.default.createElement(
	          _navLink2.default,
	          { to: '/convenience-life/newses' },
	          _react2.default.createElement(
	            _block2.default,
	            { backgroundColor: '#f6bb43', width: '185px', height: '112px', blockIcon: '/assets/images/newspaper.png' },
	            _react2.default.createElement(
	              'div',
	              { className: 'title-cn' },
	              '资讯中心'
	        ...
	        _react2.default.createElement(
	          _navLink2.default,
	          { to: '/convenience-life/jobs' },
	          _react2.default.createElement(
	            _block2.default,
	            { backgroundColor: '#37bd9c', width: '185px', height: '112px', blockIcon: '/assets/images/job-post.png' },
	            _react2.default.createElement(
	              'div',
	              { className: 'title-cn' },
	              '就业信息'
	        ...
	        _react2.default.createElement(
	          _block2.default,
	          { backgroundColor: '#ec87c1', width: '185px', height: '112px' },
	          _react2.default.createElement(
	            'a',
	            { href: 'http://app.alipay.com/home/appGateway.htm?appId=1000000020', target: '_blank' },
	            '手机充值',
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            _block2.default,
	            { backgroundColor: '#967bdc', width: '185px', height: '112px', blockIcon: '/assets/images/energy.png' },
	            _react2.default.createElement(
	              'div',
	              { className: 'title-cn' },
	              '水电煤缴费'
	        ...
	        _react2.default.createElement(
	          _block2.default,
	          { backgroundColor: '#8dc153', width: '185px', height: '112px' },
	          _react2.default.createElement(
	            'a',
	            { href: 'https://ccrprod.alipay.com/credit.htm?_pdType=bbcebbcffijdjheiaigf', target: '_blank' },
	            '信用卡还款',
	        ...
	        _react2.default.createElement(
	          _block2.default,
	          { backgroundColor: '#fb6e52', width: '185px', height: '112px' },
	          _react2.default.createElement(
	            'a',
	            { href: 'https://ebppprod.alipay.com/traffic.htm?_pdType=bbcjbfefaciiiieiijgj', target: '_blank' },
	            '交通违章',
	        ...
	        _react2.default.createElement(
	          _block2.default,
	          { backgroundColor: '#22b658', width: '185px', height: '112px' },
	          _react2.default.createElement(
	            'a',
	            { href: 'http://kx.cq.gov.cn/', target: '_blank' },
	            '开县政府网',
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            _block2.default,
	            { backgroundColor: '#169fa5', width: '185px', height: '112px', blockIcon: '/assets/images/beautiful.png' },
	            _react2.default.createElement(
	              'div',
	              { className: 'title-cn' },
	              '美丽开县'
	...
	exports.default = ConvenienceLife;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ArticleList = _react2.default.createClass({
	  ...
	  loadListFromServer: function loadListFromServer(title) {
	    var searchValue = this.props.params.searchValue;
	    if (searchValue != null) {
	      $.ajax({
	        url: _serverConfig2.default['serverUrl'] + '/api/search/' + searchValue,
	        dataType: 'json',
	        cache: false,
	        success: function (data) {
	        ...
	        error: function (xhr, status, err) {
	          console.error(_serverConfig2.default['serverUrl'] + '/api/search/' + searchValue, status, err.toString());
	        }.bind(this)
	      });
	    } else {
	      $.ajax({
	        url: _serverConfig2.default['serverUrl'] + '/api/' + title,
	        dataType: 'json',
	        cache: false,
	        success: function (data) {
	        ...
	        error: function (xhr, status, err) {
	          console.error(_serverConfig2.default['serverUrl'] + '/api/' + title, status, err.toString());
	        }.bind(this)
	      });
	    }
	  },
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      _informationBoard2.default,
	      { className: className, backgroundColor: '#f8f8f8', width: '630px', color: '#888', title: title },
	      infoList
	    );
	  }
	});
	...
	var About = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      'div',
	      { className: 'container' },
	      _react2.default.createElement(_article2.default, { params: params })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Article = _react2.default.createClass({
	  ...
	  loadArticleFromServer: function loadArticleFromServer(url) {
	    $.ajax({
	      url: url,
	      dataType: 'json',
	      cache: false,
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    this.loadArticleFromServer(_serverConfig2.default['serverUrl'] + '/api/' + this.props.params.title + '/' + articleId);
	  },
	  componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
	    this.loadArticleFromServer(_serverConfig2.default['serverUrl'] + '/api/' + this.props.params.title + '/' + articleId);
	  },
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'div',
	        { className: 'information-board article' },
	        _react2.default.createElement(
	          'div',
	          { className: 'information-title' },
	          this.state.article.title
	        ),
	        _react2.default.createElement('span', { dangerouslySetInnerHTML: { __html: this.state.article.text } })
	      )
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EducationService = _react2.default.createClass({
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            _block2.default,
	            { backgroundColor: '#f6bb43', width: '185px', height: '112px', blockIcon: '/assets/images/study-center.png' },
	            _react2.default.createElement(
	              'div',
	              { className: 'title-cn' },
	              '学习中心'
	        ...
	        _react2.default.createElement(
	          _block2.default,
	          { backgroundColor: '#37bd9c', width: '185px', height: '112px', blockIcon: '/assets/images/school.png' },
	          _react2.default.createElement(
	            'div',
	            { className: 'title-cn' },
	            '学校缴费'
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            _block2.default,
	            { backgroundColor: '#8dc153', width: '185px', height: '112px', blockIcon: '/assets/images/online-course.png' },
	            _react2.default.createElement(
	              'div',
	              { className: 'title-cn' },
	              '课程介绍'
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            _block2.default,
	            { backgroundColor: '#d870ad', width: '185px', height: '112px', blockIcon: '/assets/images/seo-training.png' },
	            _react2.default.createElement(
	              'div',
	              { className: 'title-cn' },
	              '教育培训'
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InnovationSpace = _react2.default.createClass({
	  displayName: 'InnovationSpace',
	  getInitialState: function getInitialState() {
	    return {
	      newses: [],
	      jobs: []
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            _block2.default,
	            { backgroundColor: '#ec87c1', width: '185px', height: '112px', blockIcon: '/assets/images/activities.png' },
	            _react2.default.createElement(
	              'div',
	              { className: 'title-cn' },
	              '主题活动'
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            _block2.default,
	            { backgroundColor: '#967bdc', width: '185px', height: '112px', blockIcon: '/assets/images/project.png' },
	            _react2.default.createElement(
	              'div',
	              { className: 'title-cn' },
	              '众创空间展示'
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            _block2.default,
	            { backgroundColor: '#22b658', width: '185px', height: '112px', blockIcon: '/assets/images/services.png' },
	            _react2.default.createElement(
	              'div',
	              { className: 'title-cn' },
	              '政策与服务'
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            _block2.default,
	            { backgroundColor: '#fb6e52', width: '185px', height: '112px', blockIcon: '/assets/images/incubators.png' },
	            _react2.default.createElement(
	              'div',
	              { className: 'title-cn' },
	              '入驻与孵化'
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            _block2.default,
	            { backgroundColor: '#169fa5', width: '185px', height: '112px', blockIcon: '/assets/images/support.png' },
	            _react2.default.createElement(
	              'div',
	              { className: 'title-cn' },
	              '合作与配套'
	...
	exports.default = InnovationSpace;
