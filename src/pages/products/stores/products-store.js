...
var ProductsStore = Reflux.createStore({
  ...
  init() {
    this.data = {
      products: {self_sale: [], kaixian_special: [], imported: [], daily_usage: [], wine_drink: [], beautify: [], camera: [], home_machine: [], xiangcuntuhuo: [], gongyichanping: [], gongyechanping: [], xianwaichanping: [], zhihuilvyou: [], search_result: []}
    };
