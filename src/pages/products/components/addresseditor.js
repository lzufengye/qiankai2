...
AddressEditor = React.createClass({
  ...
  componentDidMount: function () {
    ...
    $('#addressEditForm').validate({
      ignore: "",
      messages: {
        addrMan: {required: '请填写收货人姓名'},
        addrPhone: {required: '请填写收货人电话'},
        addrDetail: {required: '请填写详细收货地址'},
    ...
    return (
      <div className="row">
        <form method="post" className="qing-pad-tb-10 col-md-12 form-horizontal" id="addressEditForm">
              ...
              <div className="cart-region-selector">
                ...
                <div className="cart-region-list hide">
                  <ul className="nav nav-tabs nav-justified nav-region">
                    <li className="active">
                      <a htmlFor="provinceTab">{'省份'}</a>
                    </li>
                    <li>
                      <a htmlFor="cityTab">{'城市'}</a>
                    </li>
                  </ul>
          ...
          <div className="form-group">
            <label className="col-md-3 align-right control-label">{'详细地址'}</label>
            <div className="col-md-9">
          ...
          <div className="form-group clearfix">
            ...
            <div className="col-md-9">
              <label className="radio-inline qing-radio">
                <input type="radio" name="isDefault"  value="1" checkedLink={defaultAddress.valueLink('1')}/>
                <i></i>{'是'}
              </label>

              <label  className="radio-inline qing-radio">
                <input type="radio" name="isDefault" value="0" checkedLink={defaultAddress.valueLink('0')}/>
                <i></i>{'否'}
              </label>
            </div>
          </div>
